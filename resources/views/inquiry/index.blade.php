			...
			<div class="col-lg-6 content-right">
				<div id="wizard_container">
					<div id="top-wizard">
						...
						<!-- /top-wizard -->
						<form id="wrapped" method="POST" action = "{{route('inquiry.store')}}">
						{{ csrf_field() }}
							...
							<div id="middle-wizard">
								<div class="step">
									<h3 class="main_question"><strong>1/3</strong>Fordern Sie ihr Angebot an</h3>
								    <div class="form-group">
										<div class="styled-select clearfix">
											<select class="wide time required" name="time">
												<option value="">Wann können wir Sie am besten erreichen?</option>
									...
									<div class="form-group">
										<div class="styled-select clearfix">
											 <select class="required ddslick" name="treatments">
												<option value="" data-imagesrc="{{asset('assets/img/icons_select/select_treatment.svg')}}">Welche Art von App möchten Sie entwickeln?</option>
                                        		<option value="iOS" data-imagesrc="{{asset('assets/img/icons_select/apple.svg')}}">iOS </option>
                                                <option value="Android" data-imagesrc="{{asset('assets/img/icons_select/android.svg')}}">Android<i class="fas fa-turntable"></i></option>
                                        		<option value="Hybrid" data-imagesrc="{{asset('assets/img/icons_select/hybrid.svg')}}">Hybrid</option>
                                        		<option value="PWA" data-imagesrc="{{asset('assets/img/icons_select/pwa.svg')}}">PWA</option>
											</select>
										</div>
									</div>
								...
								<div class="step">
									<h3 class="main_question"><strong>2/3</strong>In Welcher Kategorie würden Sie Ihre App einordnen?</h3>
									<div class="form-group options clearfix">
										<i class="fas fa-store"></i><em>E-Commerce </em>
										<label class="switch-light switch-ios float-right">
										<input type="checkbox" value="E-Commerce" name="options[]">
										<span><span>Nein</span><span>Ja</span></span>
										<a></a>
										</label>
									</div>
									<div class="form-group options clearfix">
										<i class="fas fa-turntable"></i><em>Entertainment	</em>
										<label class="switch-light switch-ios float-right">
										<input type="checkbox" value="Entertainment" name="options[]">
										<span><span>Nein</span><span>Ja</span></span>
										<a></a>
										</label>
									</div>
									<div class="form-group options clearfix">
										<i class="fal fa-user-chart"></i><em>Business Intelligence	</em>
										<label class="switch-light switch-ios float-right">
										<input type="checkbox" value="BI" name="options[]">
										<span><span>Nein</span><span>Ja</span></span>
										<a></a>
										</label>
									</div>
									<div class="form-group options clearfix">
										<i class="fas fa-brain"></i><em>Artificial Intelligence	</em>
										<label class="switch-light switch-ios float-right">
										<input type="checkbox" value="AI" name="options[]">
										<span><span>Nein</span><span>Ja</span></span>
										<a></a>
										</label>
									</div>
								...
								<div class="submit step">
									<h3 class="main_question"><strong>3/3</strong>Bitte hinterlassen Sie hier ein paar persönliche Angaben</h3>
									<div class="form-group">
										<input type="text" name="first_name" class="form-control required" placeholder="Name">
										<i class="icon-user"></i>
									</div>
									<div class="form-group">
										<input type="text" name="last_name" class="form-control required" placeholder="Firma">
										<i class="icon-user"></i>
									</div>
									<div class="form-group">
									...
									<div class="form-group terms">
										<label class="container_check">Bitte akzeptieren Sie unsere  <a href="#" data-toggle="modal" data-target="#terms-txt">Datenschutzerklärung</a>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p>Google Adsense, Google Analytics, Leadcollect</p>
					...
					<p>Tridhya Tech GmbH, 
					<br>Nürnberger Straße 46, 
					<br>90579 Langenzenn</p>
					<hr>
